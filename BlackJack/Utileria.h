 ...
 *
 */
void DibujarArchivo(const char *direccion ,int posX=0 ,int posY=0 ,Color colFondo=NEGRO ,Color colTex=BLANCO ,bool espacios=true);
 ...
 *
 */
void AnimarArchivo(const char *direccion ,double segundos ,double repeticiones=1,int posX=0 ,int posY=0 ,Color colFondo=NEGRO ,Color colTex=BLANCO);
